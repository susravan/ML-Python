...
# Took most common words from different languages and compared the input text to these words
...
def cleanString(str):
	...
	table = string.maketrans("","")		# Ref - http://stackoverflow.com/questions/36464160/what-does-python-string-maketrans 
